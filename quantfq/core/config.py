"""
Configuration management for QuantFQ.
"""
...
class Config:
    """Configuration manager for QuantFQ."""
    ...
    def _get_project_root(self) -> Path:
        ...
        # Go up from quantfq/core/config.py to project root
        # quantfq/core/config.py -> quantfq/core -> quantfq -> project_root
        for parent in current.parents:
            if (parent / "setup.py").exists() or (parent / "pyproject.toml").exists():
                return parent
        # If not found, assume quantfq package is 2 levels up from config.py
